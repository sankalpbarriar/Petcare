...
export default function Page({ searchParams }: {
  ...
  return (
    <main className='flex flex-col items-center space-y-10 md:p-10'>
      <H1 className='text-xl md:text-2xl'>PetCare access required payment</H1>
        ...
        )}
      {
        searchParams.cancelled && (
          <p className='text-sm text-red-700 px-4'>
